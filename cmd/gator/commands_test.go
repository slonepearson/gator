...
func TestNonRegisteredCommands(t *testing.T) {
	...
	handlers.Register("login", "login a user", "login <username>", 1, false, HandlerLogin)
	handlers.Register("register", "register a user", "register <username>", 1, false, HandlerRegister)
